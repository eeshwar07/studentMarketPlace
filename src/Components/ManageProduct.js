...
export default function ManageProduct() {
  ...
  return (
    ...
    <div className="owner">
        ...
        <button style={{margin: '10px 10px'}}><a style={{color:'aliceblue'}} href="manageproduct.html">Manage a product</a></button>
        ...
        <div className="rows">   
            <div className="columns">  
             <div className="card">
              ...
              <h1>Mattress</h1>
              <p className="price">$129.99</p><br></br>
              <p>Memory foam mattress.</p><br></br>
          ...
          <div className="rows">   
            <div className="columns">  
             <div className="card">
              <img src={Studytable} alt="Study Table" style={{width:'100%'}}/>
              <h1>Study Table</h1>
