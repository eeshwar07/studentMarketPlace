...
export default function Advertisement1() {
  ...
  const handleSubmit = async (e) => {
    ...
    Axios.post(baseURL + "postadvertisement.php", input).then((res) => {
  ...
  return (
    <>
      ...
      <div className="owner">
        ...
        <button style={{ margin: "10px 10px" }}>
          <a href="removeproduct.html">Remove a product</a>
        </button>
        <button style={{ margin: "10px 10px" }}>
          ...
          <div className="box">
            <div className="message-box">
              <textarea
                ...
                placeholder="Write a blog here to post as advertisement"
              ></textarea>
            </div>
