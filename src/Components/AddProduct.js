...
console.log(e.target.files[0]);
  ...
  const handleSubmit = async (e) => {
    ...
    Axios.post(baseURL+'addproduct',input).then((res) => {
  ...
  return (
    ...
    <form action="addproduct" onSubmit={handleSubmit}>
      <h1 align="center" style={{color:'black'}}>Enter details of product:</h1>
      <div className="card">
          <div className="form-div-tag">
          <input style={{display: 'flex',justifyContent: 'center',width: '180px'}}
           type="file" id="myFile" name="image" onChange={handleFileChange}/>
          </div>
          <div className="form-div-tag">
          <input type="text" placeholder="Enter name of product" name="name" onChange={handleChange}></input>
          </div>
          <div className="form-div-tag">
          <input type="text" placeholder="Enter price of product" name="price" onChange={handleChange}></input>
          </div>
          <div className="form-div-tag">
            <label>Description of product:</label>
          </div>
          <div className="form-div-tag">
            <textarea className="textarea" rows="4" cols="20" name="description" onChange={handleChange}></textarea><br></br>
          </div>
