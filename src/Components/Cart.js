...
import Notebook from "../assets/images/notebook.jfif";
import Bedframe from "../assets/images/bed frame.jfif";
        ...
        {users.map((user, key) => (
          <>
            <div className="card" key={key}>
              ...
              <div>
                <p className="price">${users.length > 0 ? user.price : null}</p>
              </div>
              <div style={{ height: "30px" }}>
                <p>{users.length > 0 ? user.description : null}</p>
              </div>
            </div>
          </>
        ))}
      ...
      {users.length > 0 ? (
        ...
        >
          <button style={{ width: "150px" }}>
            <a href="payment.html" style={{ color: "brown" }}>
              Proceed to checkout
            </a>
          </button>
        </div>
